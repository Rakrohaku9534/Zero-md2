...
export async function handler(chatUpdate) {
    ...
    global.img = 'https://telegra.ph/file/8b7dafb99fde2c3205a5b.jpg' 
    ...
    switch (action) {
        ...
        case 'remove':
            if (chat.welcome) {
                ...
                let welc = 'WELCOME'
                    let outss = 'GOOD BYE'
                    let pp = 'https://telegra.ph/file/8b7dafb99fde2c3205a5b.jpg'
                    try {
                        pp = await this.profilePictureUrl(user, 'image')
                    } catch (e) {
                    } finally {
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user').replace('@subject', await this.getName(id)).replace('-', groupMetadata.desc?.toString() || 'unknow') :
...
externalAdReply: {
title: v,
thumbnailUrl: "https://telegra.ph/file/8b7dafb99fde2c3205a5b.jpg",
sourceUrl: sgc,
mediaType: 1,
...
externalAdReply: {
title: v,
thumbnailUrl: "https://telegra.ph/file/24f38f1982ea8358cc482.jpg",
sourceUrl: sgc,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
...
global.thumbdoc = 'https://telegra.ph/file/24f38f1982ea8358cc482.jpg'
global.logo = 'https://telegra.ph/file/24f38f1982ea8358cc482.jpg'
global.hyuri = ['https://telegra.ph/file/5d908f4a17515a15c6202.jpg']
global.thumb = 'https://telegra.ph/file/2e8d2ef0926e848626a43.jpg' 
global.imagebot = 'https://telegra.ph/file/24f38f1982ea8358cc482.jpg'
...
global.thumbs = ['https://telegra.ph/file/24f38f1982ea8358cc482.jpg']
